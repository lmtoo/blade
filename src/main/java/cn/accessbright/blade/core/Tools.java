...
import com.icitic.hrms.core.resource.ViewConfigPropertiesHolder;
...
import com.icitic.hrms.core.util.ListArrayUtil.MapReduce;
...
import com.icitic.hrms.sys.pojo.vo.CellVO;
import com.icitic.hrms.sys.pojo.vo.RecordVO;
import com.icitic.hrms.sys.pojo.vo.TableVO;
...
//        if ("".equals(compare1) || "".equals(compare2)) return -2;
     ...
     */
    public static String formatDate(java.util.Date dt, String dateFormat) {
    ...
    public static java.sql.Date toSQLDate(String strDate, String pattern) {
        ...
        java.util.Date d = formatter.parse(strDate, new ParsePosition(0));
